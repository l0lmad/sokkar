...
import { PlusCircle, CheckCircle, MapPin, Image, Video, X, Plus, ExternalLink, User, Globe, Upload } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-xs text-gray-400 mt-1">
              يمكنك رفع الصور من جهازك أو إضافة روابط من الإنترنت
            </p>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
              <label className="px-4 py-3 bg-orange-100 text-orange-600 rounded-xl hover:bg-orange-200 transition-colors cursor-pointer flex items-center gap-2">
                <Upload size={20} />
                <input
                  type="file"
                  accept="video/*"
